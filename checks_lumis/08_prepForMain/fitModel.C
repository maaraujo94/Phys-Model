...
public:
  ...
  void plotHist() {
    ...
    ld.DrawLatex(xpos, getPos(h_dev->GetMinimum(), h_dev->GetMaximum(), 3./5., 0), Form("Gaussian fit #mu = %.1f", fg->GetParameter(1)));
    ld.DrawLatex(xpos, getPos(h_dev->GetMinimum(), h_dev->GetMaximum(), 2.5/5., 0), Form("Gaussian fit #sigma = %.1f", fg->GetParameter(2)));
    ...
    lp.DrawLatex(xpos, getPos(h_pulls->GetMinimum(), h_pulls->GetMaximum(), 3./5., 0), Form("Gaussian fit #mu = %.2f", fg->GetParameter(1)));
    lp.DrawLatex(xpos, getPos(h_pulls->GetMinimum(), h_pulls->GetMaximum(), 2.5/5., 0), Form("Gaussian fit #sigma = %.2f", fg->GetParameter(2)));
