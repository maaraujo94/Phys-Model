/////////////////////////////////////////////////////////////////////////
// function that initializes fit values and performs the fitting on a  //
// cycle that samples several (initial or fixed) values for parameters //
/////////////////////////////////////////////////////////////////////////
...
void fit()
{
  ...
  double param[nparam], ptmmin = 2., chisquare, L_est[2];
  float PTMNORM = 4.;
  ...
  // initial or fixed values over which we'll be cycling
  // careful not to create a too big cycle: will be hard to parse results
	...
	for(int ib = 0; ib < n_s; ib++)
	  for(int itau = 0; itau < n_tau; itau++)
	      ...
	      for(int i = 0; i < (int)datasigma[0].size(); i++)
		{
	      ...
	      // results saved to a file with one line per element of cycle
